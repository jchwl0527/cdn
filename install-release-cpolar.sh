...
download_cpolar() {
  DOWNLOAD_LINK="http://static.cpolar.com/downloads/releases/$RELEASE_VERSION/cpolar-stable-linux-$MACHINE.zip"
...
decompression() {
  ...
  DOWNLOAD_CONFIG_LINK="http://static.cpolar.com/downloads/cpolar.demo.yml" 
  ...
  DOWNLOAD_SERVICE_CONFIG_LINK="http://static.cpolar.com/downloads/cpolar.service"
  ...
  DOWNLOAD_SERVICE_AT_CONFIG_LINK="http://static.cpolar.com/downloads/cpolar@.service"
